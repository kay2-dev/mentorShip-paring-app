CREATE TYPE "public"."request-status" AS ENUM('accepted', 'declined');--> statement-breakpoint
...
ALTER TABLE "requests" ADD CONSTRAINT "requests_mentor_id_users_id_fk" FOREIGN KEY ("mentor_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "requests" ADD CONSTRAINT "requests_mentee_id_users_id_fk" FOREIGN KEY ("mentee_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "users" ADD CONSTRAINT "mentee_fk" FOREIGN KEY ("mentee_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "mentee_request_index" ON "requests" USING btree ("mentee_id");--> statement-breakpoint
