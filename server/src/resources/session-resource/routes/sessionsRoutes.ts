...
sessionsRouter.post(API_END_POINTS.sessionsEndPoints.sessions, authGuard, checkRole("mentee"), validateIncomingData(zodBookSessionSchema), createSessionController);
